...
public final class AZDropdownMenuDefaultCell: AZDropdownMenuBaseCell {
    ...
    public func setupForDefaultLayout() {
        ...
        if (!self.isSetupFinished) {
            ...
            let width = NSLayoutConstraint.constraints(withVisualFormat: "H:|-0-[container]-0-|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: bindings)
            let height = NSLayoutConstraint.constraints(withVisualFormat: "V:|-0-[container]-0-|", options: NSLayoutFormatOptions(rawValue: 0), metrics: nil, views: bindings)
